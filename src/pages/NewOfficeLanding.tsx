          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {[
              ...
              return (
                ...
                <div
                  className="group relative rounded-3xl p-8 sm:p-9 border border-transparent hover:border-[var(--color-olive)]/20 shadow-[0_1px_2px_rgba(74,68,56,0.05)] hover:shadow-[0_24px_48px_-22px_rgba(74,68,56,0.25)] hover:-translate-y-1 transition-all duration-300 overflow-hidden"
                  style={{
                    background:
                ...
                >
                  ...
                  <div className="flex items-center justify-center w-12 h-12 rounded-2xl bg-[var(--color-sage)] text-[var(--color-olive)] shadow-[0_1px_2px_rgba(74,68,56,0.06)] group-hover:bg-[var(--color-olive)] group-hover:text-white group-hover:shadow-[0_8px_20px_-6px_rgba(47,74,14,0.4)] transition-all duration-300">
